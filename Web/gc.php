...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
      ...
      function drawDistanceChart() {
        ...
        var options = {
          chart: {
            ...
            subtitle: 'Day, Distance(km): day1-day30',
          }
        };
 ...
 <!-- 넘어지는 횟수 차트 -->    
     function drawFallDownChart() {
        ...
        var options = {
          chart: {
            title: 'How much Hyunah fell down',
...
<p>What is GuardiCycle? 
Guardicycle is a bicycle for children aged between 4 and 8. 
It measures how long, and how much they rode a bicycle.
It also measures where they have been during their riding. 
The main function for this bicycle is analyzing each child's riding pattern and educate if they're riding dangerously.</p>
...
<div id="sub-content">
  <article class="container">
    ...
    <p>Today, Hyunah rode bicycle for 0.3 kilometers.</p>
    </br>
    </br>
    <h3>How much have they fall down?</h3>
    <p>Today, Hyunah fell down for 3 times.</p>
    </br>
    </br>
...
<p>The graph below shows the distance while your child was riding.</p>
...
<p>The graph below shows information that indicates how many times your child had fall down while riding.</p>
...
<br>
<font size="4"> Enter latitude, longitude of your home. </font>
...
<br>
<font size="4"> Enter latitude, longitude of dangerous places that your child must not access. </font>
...
<p>The graph below shows analysis about how many times your child had fall down and how much they rode during their riding.</p>
